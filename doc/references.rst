...
:class:`~combisurf.partial_sums.PartialSumsBinarySplitting` and the sweep of
:func:`~combisurf.crossing_arcs.crossing_arcs_sweep`, where it answers each
prefix sum and each update in logarithmic time.
